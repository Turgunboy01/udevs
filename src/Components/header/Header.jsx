            ...
            <li className="hidden group-hover:block w-[300px] absolute top-[30px] -left-20  bg-[#fff] ">
              <div className="flex flex-col gap-2 py-5 ">
                ...
                <Link
                  ...
                  duration={500}
                  style={{ border: "none" }}
                  className="text-[14px] px-8 border-b-[2px] border-b-[#1b59f700] hover:bg-[#1b5bf7] py-2  cursor-pointer flex items-center gap-4"
                >
                  <img src={ser1} alt="" />
                ...
                <Link
                  ...
                  duration={500}
                  style={{ border: "none" }}
                  className="text-[14px] px-8 border-b-[2px] border-b-[#1b59f700] hover:bg-[#1b5bf7] py-2 font-bold cursor-pointer flex items-center gap-4"
                >
                  <img src={ser4} alt="" />
                  IT consulting
                </Link>
